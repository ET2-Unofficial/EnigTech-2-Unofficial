## The scripts is copyright by CleanroomMC/CleanroomMMC
...
dotenv.load_dotenv()
# Init variables
VERSION = '0.2.1-alpha+build.10.run.616'
COMMIT_HASH = 'e84be9c'
RUN_JOB_URL = 'https://github.com/CleanroomMC/Cleanroom/actions/runs/9189505553'
PATH_TO_EXIST_INSTALLER = os.getenv('PATH_TO_EXIST_INSTALLER')
BRANCH = 'experimental/foundation'
...
shutil.copytree('EnigTech2', output_path, dirs_exist_ok=True, ignore=shutil.ignore_patterns('*net.minecraft.json'))
...
shutil.copyfile(
    os.path.join(template_path, 'patches', ("old_" if False else "") + 'net.minecraft.json'),
